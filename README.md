...
**SAP Labs India** — Associate Software Engineer *(Aug 2024 – Present)*

- **SAP Ariba SCM BN** *(May 2025 – Present)*: Building features on the Supplier Information Portal, implementing event-driven handlers and OData V4 services using SAP CAP
- **SAP SuccessFactors Employee Central** *(Aug 2024 – May 2025)*: Automated 50+ end-to-end HR workflows using Cucumber and ADF frameworks; maintained SIT pipelines to ensure release quality and eliminate manual regression testing
